...
- **fix:** конфликт `awg-quick@awg0.service` и `amneziawg-awg0.service` на exit-ноде — старый сервис теперь останавливается перед запуском нового, устраняя проблему "awg show пустой" и черепашьей скорости (~3 КБ/с)
