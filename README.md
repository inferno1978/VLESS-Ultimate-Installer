# VLESS Ultimate Installer v4.11.4

[![Version](https://img.shields.io/badge/version-4.11.4-blue.svg)](https://github.com/inferno1978/VLESS-Ultimate-Installer)
...
| **v4.11.4 NEW** 🔥 | Telemt MTProto на entry-ноде → xray-каскад → Telegram (VLESS / AWG 2.0) |
...
### Telemt MTProto — интеграция с xray-каскадом `[v4.11.4]`
...
/etc/ipset.conf              # [v4.11.4] Дамп ipset для восстановления при reboot
/var/log/
├── vless-install.log        # Лог установщика
├── nginx-watchdog.log       # [v4.11.4] Лог nginx watchdog
└── xray-ipset-restore.log   # [v4.11.4] Лог восстановления ipset
```
